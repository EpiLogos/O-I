...
function Shell(){
 const [layout,setLayout]=useState(initial),stage=useExpressionStage();
...
createRoot(document.getElementById('root')!).render(<KernelProvider><ExpressionStageProvider><ExpressionProvider><Shell/></ExpressionProvider></ExpressionStageProvider></KernelProvider>);
