#!/usr/bin/env python3
"""Controlled protocol fixture for the select-send walk.

Copied from the bound ai-kit candidate revision (PR #278 head 3d23d1e,
crates/aikit-cli/tests/fixtures/caw_provider.py). FIXTURE_REPLY is a scripted
protocol transport, never a model or harness response; walks built on it stay
D/C evidence. Behaviour is unchanged from the owner fixture except this header.
"""
