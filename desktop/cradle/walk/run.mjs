...
const SCENARIOS = {
  ...
  "factory-inhabitation": {module:"scenarios/factory-inhabitation.mjs",kernel:true,aliases:["inhabit"]},
  "factory-inhabitation-fixture": {module:"scenarios/factory-inhabitation-fixture.mjs",kernel:true,aliases:["inhabit-fixture"]},
  "factory-sensing": {module:"scenarios/factory-sensing.mjs",kernel:true,aliases:["sense"]},
...
const SCENARIO_SPEC = {
  ...
  "factory-inhabitation": { spec_ref: "docs/contracts/WORLD-INHABITATION-V1.md §3 §4; docs/research/openrig-c8fca9d/CROSSWALK.md §8 §15; docs/cradle/11-FACTORY.md §3.4 §5; 10-SIDEBARS.md §4.5 (live, real Central, read-only)" },
  "factory-inhabitation-fixture": { spec_ref: "docs/contracts/WORLD-INHABITATION-V1.md §3 §4 (controlled standings and refusals)", grade: "D" },
  "factory-sensing": { spec_ref: "docs/cradle/11-FACTORY.md §3.4 §5; Factory telemetry commission §§13/21 (native signals, decisions, history, coverage)" },
