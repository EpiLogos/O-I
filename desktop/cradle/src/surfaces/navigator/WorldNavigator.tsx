...
export function WorldNavigator({ onSystem, onOpenWorkingChanges, onOpenProjectNow, onOpenAgents, onFactoryDevelopment,onOpenEncounter, centralFiles, onCentralFilesChange, workspaceSelector, searchShortcut, projectNavigation, onNavigationChange, onOpenFile, onProjectChange, onOpenWiki, onSearch, onOpenToday, activeEncounterRef, onOpenFlowInstance, onNewFlow }: { onSystem:()=>void;onOpenWorkingChanges?:(project:string,ref?:string)=>Promise<void>;onOpenProjectNow?:(project:string,ref?:string)=>Promise<void>;onFactoryDevelopment?:(project:string,ref?:string)=>Promise<void>;onOpenAgents?:(project:string,ref?:string)=>Promise<void>;onOpenEncounter:(row:EncounterRow)=>Promise<void>; centralFiles: boolean; onCentralFilesChange:(files:boolean)=>void; workspaceSelector: ReactNode; searchShortcut: string; projectNavigation: Record<string, ProjectNavigation>; onNavigationChange: (ref: string, change: Partial<ProjectNavigation>) => void; onSearch: () => void; onOpenWiki: (ref:string,title:string,project?:string)=>Promise<void>; onOpenFile: (location:CentralLocation)=>Promise<void>; onProjectChange?: (project?: string) => void; onOpenToday?: () => Promise<void>; onAgent?: () => void; activeEncounterRef?: string; onOpenFlowInstance?: (row:import("../../flow/instances").FlowInstanceRow)=>Promise<void>; onNewFlow?: ()=>void }) {
