...
export interface RunMapNode { id: string; kind: string; label: string; state?: string|null }
export interface RunReading { contract: "factory.run-reading/v1"; runRef: string; projectRef: string; lifecycle: string; destination: string; runMap: {nodes: Record<string, RunMapNode>} }
