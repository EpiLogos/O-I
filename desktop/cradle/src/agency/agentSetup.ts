...
export type AgentSetupTopic="world"|"acceptance"|"harness"|"credentials"|"skills";
...
export interface AgentSetupTarget {project?:string;destination?:AgentSetupDestination;reason:string;refresh:()=>Promise<unknown>|void;returnTo?:()=>void}
...
export function openAgentSetup(next:AgentSetupTarget){
 target={...next,destination:next.destination??{owner:"ai-kit",topic:"harness"}};announce();
