  ...
  return (
    <>
      ...
      {stageCentres.map(({mode: stageMode, binding}) => {
        ...
        return (
          <div key={`mode-stage-${stageMode}`} className="mode-stage" data-mode-stage={stageMode} data-window-corner="true" data-window-corner-left="true" hidden={!presented || undefined}>
