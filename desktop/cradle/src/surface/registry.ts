 ...
 */
const FRAME_DISCLOSED_KINDS = new Set(["source", "sources", "knowledge", "file", "encounter", "system", "browser", "terminal", "flow", "blank", "factory", "instrument", "factory-handoff", "factory-material", "project-now", "agents", "observatory", "draft", "development-field"]);
