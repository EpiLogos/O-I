...
export type SharedFieldRequest=Record<string,unknown>&{kind:"status"|"snapshot"|"read"|"publish"|"participant"|"admit"|"contact"};
...
export type SharedFieldReading=
  ...
  |{schema:"oi.shared-field.reading/v1";ref:string;state:"hosted";target:SharedFieldTarget;entry:HostedEntry;projections:HostedProjection[];relations:HostedRelation[];contributions:unknown[];neighbourhood:unknown;status:unknown}
