...
export type SharedFieldReading=
  ...
  |{schema:"oi.shared-field.reading/v1";ref:string;state:"hosted";target:SharedFieldTarget;field_ref:string|null;entry:HostedEntry;projections:HostedProjection[];relations:HostedRelation[];contributions:HostedContribution[];owner_pending_contributions:HostedPendingContribution[];neighbourhood:unknown;my_authority:HostedAuthority[];my_watches:HostedWatch[];status:unknown}
