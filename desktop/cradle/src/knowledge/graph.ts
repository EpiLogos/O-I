...
export interface GraphNode {ref:string;kind:"wiki-space"|"wiki-node"|"file"|"flow"|"skill"|"knowledge-subject"|HostedGraphKind|(string&{});label:string;native_owner:string;provenance:GraphProvenance;actions:string[];address?:KnowledgeAddress;tags?:string[];aliases?:string[]}
...
export interface GraphEdge {reference?:string;authored_relation?:import('./wikiDocument').WikiEvidence;containment?:'encloses'|'enclosed-by';origin?:{provider?:string;revision?:string;authority?:string};relation:"space-child-space"|"space-node"|"node-space"|"node-source"|(string&{});from_ref:string;to_ref:string;provenance:GraphProvenance}
...
export interface GraphFormation {ref:string;members:{ref:string;role?:string|null;conjugate?:boolean}[];shape_ref?:string;partial?:boolean;revision?:number|string;anchor_ref?:string|null}
