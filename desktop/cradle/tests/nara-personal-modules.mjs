...
export async function modules(){
 ...
 const entry=`export * from './src/nara/personal/client.ts';export * from './src/nara/personal/identityMaterial.ts';export * from './src/nara/personal/operations.ts';export * from './src/nara/personal/ground.ts';export * from './src/nara/personal/flowReturn.ts';export * from './src/nara/identityPresentation.ts';export * from './expressions-app/field-studies-journeys/src/privateIdentity.ts';`;
