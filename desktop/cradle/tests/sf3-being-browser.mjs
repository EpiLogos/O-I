...
try{
 ...
 console.log(`SF3 hosted Being desktop walk passed against ${process.env.OI_SHARED_FIELD_TARGET}: ${await being.getAttribute('data-being-ref')}`);
