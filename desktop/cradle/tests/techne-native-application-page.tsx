...
createRoot(document.getElementById('root')!).render(<KernelProvider><VisualsProvider><main style={{height:'100vh',width:'100vw',display:'flex'}}><PointCloudHost mode="techne"/></main></VisualsProvider></KernelProvider>);
