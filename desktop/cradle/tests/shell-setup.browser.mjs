...
const receipt={...receiptIdentity(import.meta.url),classification:'controlled C0 source, real PlanDrawer and full presentation tokens; no native writes',checks:[],failures:[],passed:false};
try{
