...
createRoot(document.getElementById("root")!).render(<KernelProvider><main style={{height: "100%", fontFamily: "var(--oi-font-sans)"}}><LibraryBrowser mode="techne" initialScope="local"
  onOpen={(item, how) => { opened.push({item, how}); }}/></main></KernelProvider>);
