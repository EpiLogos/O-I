...
export class NativeDomainView {
  ...
  constructor(){
    ...
    this.element.innerHTML=`<output data-domain-state></output><svg viewBox="-1.2 -1.2 2.4 2.4" width="76" height="76" role="img" aria-label="Native M1 quadrature and continuous clock"><line data-carrier x1="0" y1="0"/><line data-opposite x1="0" y1="0"/><line data-clock x1="0" y1="0" x2="0" y2="-1"/></svg><strong data-transcription></strong><span data-form-source></span><span data-form-angles></span><span data-native-clock></span>`;
