 ...
 * scene replacement.
 */
/** Shared by the retained legacy host and the embedded application. */
export function withRetainedField(ProductionAdapter, WORLD_SCALE) {
return class RetainedProductionAdapter extends ProductionAdapter {
  constructor(canvas) {
    super(canvas);
