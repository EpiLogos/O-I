...
const PARAM_REGISTRY = [
  ...
  P("material.sizeBias", "Size Distribution", "Material", 0.2, 4, 0.1, 12, 0.05),
  ...
  P("fluid.vortexRadius", "Vortex Radius", "Physics+", 20, 2e3, 5, 2e4, 5, { decimals: 0, unit: "px" }),
  ...
  P("fluid.maxSpeed", "Speed Limit", "Physics+", 50, 6e4, 10, 1e7, 50, { decimals: 0 }),
  ...
  P("toroidalMorph.progress", "Manifold Scrub", "Morph", 0, 1, 0, 1, 5e-3, { decimals: 3 }),
  ...
  P("toroidalMorph.manifoldRadius", "Manifold Radius", "Morph", 10, 1200, 1, 2e4, 5, { unit: "px" }),
  P("toroidalMorph.volumetricDepthScale", "Volumetric Depth", "Morph", 0, 6, 0, 100, 0.05),
  // ---- Interaction ----
  P("interaction.radius", "Cursor Radius", "Interaction", 10, 2e3, 0, 5e4, 10, { unit: "px" }),
  ...
  P("relational.gravitySoftening", "Gravity Softening", "Relational", 1, 500, 1, 1e5, 1, { unit: "px" }),
  P("relational.gravityFalloff", "Gravity Falloff", "Relational", 0.5, 3, 0.1, 10, 0.01),
  P("relational.swirlRadius", "Swirl Radius", "Relational", 20, 3e3, 5, 1e5, 10, { unit: "px" }),
  // ---- Color ----
  P("color.cycleSpeed", "Cycle Speed", "Color", -10, 10, -1e3, 1e3, 0.1),
  P("color.hueShiftSpeed", "Hue Shift Speed", "Color", -6, 6, -1e3, 1e3, 0.05),
  P("color.waveFrequency", "Wave Frequency", "Color", 0.05, 24, 0, 1e3, 0.1),
  ...
  P("cymatics.frequencyHz", "Drive Frequency", "Cymatics", 20, 4e3, 1, 1e5, 1, { decimals: 0, unit: "Hz" }),
  P("cymatics.dominance", "Dominance", "Cymatics", 0, 1, 0, 1, 0.01, { hint: "0 = pure formation springs, 1 = pure resonator transport" }),
  P("cymatics.dampingQFactor", "Q Factor", "Cymatics", 0.1, 40, 0.01, 1e4, 0.1),
  ...
  P("cymatics.plateSize", "Plate Size", "Cymatics", 100, 2e3, 10, 2e4, 5, { unit: "px" }),
  ...
  P("cymatics.baseFrequency", "Resonator f0", "Cymatics", 5, 200, 0.5, 2e3, 0.5, { unit: "Hz", hint: "f_mn = f0 * (m^2 + n^2); tunes the band to ~80-1100Hz" }),
  P("cymatics.sweepSpeed", "Sweep Period", "Cymatics", 0.05, 600, 0.01, 1e5, 0.05, { unit: "s" }),
