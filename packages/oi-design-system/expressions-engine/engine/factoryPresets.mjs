...
const FACTORY_PRESETS = [
  {
    ...
    description: "Two inverse Hopf fibration manifolds intersecting on an S\xB3 hypersphere with dynamic chiral coupling and interference oscillations",
    config: {
      glyph: ["\u23E3", "\u262F"],
      style: "stipple",
      dotShape: "circle",
