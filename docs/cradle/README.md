...
| [10-SIDEBARS.md](10-SIDEBARS.md) | The left and right sidebars in every mode and state, with the acceptance check for each state (proposed; awaiting owner Recognition). Visual study: [sidebars/sidebars-study.html](sidebars/sidebars-study.html). |
