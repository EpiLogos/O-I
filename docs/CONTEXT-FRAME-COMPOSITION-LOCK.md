...
**Status:** the composition contract, lifecycle planner, cross-cell composition and acceptance-campaign increments are landed — [#311](https://github.com/EpiLogos/O-I/pull/311) and [#341](https://github.com/EpiLogos/O-I/pull/341) here, Workcell [#82](https://github.com/EpiLogos/Workcell/pull/82) for the connection lifecycle. Physical acceptance on the second machine has since run under its separate, explicit authorisation (2026-09-14 and 2026-09-15); the daily-use machine stayed protected. What remains open is named once, in [CONTEXT-FRAME-ACCEPTANCE-CAMPAIGN.md](CONTEXT-FRAME-ACCEPTANCE-CAMPAIGN.md) §6.
