...
import { contributionBody, createAttachedContribution, inspectContributionBasis, nativeExpressionReturnProposal, nativeReturnSubmission } from './contribution-return.mjs';
...
test('Expression material routes to EX1 propose with its exact ref, basis and Changes', () => {
  const value=contribution({body:{kind:'expression-scene',basis,content:{summary:'Add the returned scene',changes:[{change:'scene_create',scene_ref:'scene:returned',title:'Returned'}]},attachments:[]}});
